class TabLink {
  ...
  selectTab(){
    ...
    // and invoking selectCard() from the TabCard class. Just un-comment the code and study what is happening here.
...
- With your selection in place, now chain a .forEach() method onto the tabs variable to iterate 
